...
const projects = [
   ...
   {icon: '◈', title: 'CTF Writeup Library', body: 'A shared collection of solve notes, tooling tips, and lessons from competitions.'},
   {icon: '⌁', title: 'CTF Team Finder', body: 'A student-first way to connect teammates by interests, experience, and availability.'},
];
const resources = [
...
const Home: NextPage = () => {
   ...
   useEffect(() => {
      ...
      const savedTheme = window.localStorage.getItem('cybersociety-theme');
      ...
      const setTheme = (dark: boolean) => {
         ...
         window.localStorage.setItem('cybersociety-theme', dark ? 'dark' : 'light');
      };
   ...
   return <><Head><title>McMaster CyberSociety | CTF & Learning Hub</title><meta name="description" content="CTF standings, cybersecurity learning resources, events, and projects for McMaster CyberSociety." /><link rel="icon" href="/McMaster-Cybersociety-Logo.jpg" /></Head>
      ...
      <footer><div className="section-shell footer-inner"><a className="brand" href="#home"><img src="/McMaster-Cybersociety-Logo.jpg" alt="McMaster CyberSociety logo" /><span><strong>McMaster</strong><small>CyberSociety</small></span></a><p>Learn, build, and compete together.</p><a href="#home">Back to top ↑</a></div></footer></>;
};
export default Home;
